...
(7, 11, 'purchase', 10, 160.00, '2024-09-01', 4, '2024-09-02 02:39:53', '2024-09-02 07:06:27'),
...
(17, 9, 'rj45', 'Connector', 100, 10.00, '2024-09-02 06:31:49', '2024-09-02 06:31:49');
...
(8, 12, 22, '426546-45345', '', '2024-09-01', 'returned', '2024-09-02 02:31:34', '2024-09-02 02:31:42', NULL),
(9, 12, 20, '4154-0456-', '', '2024-09-01', 'in_use', '2024-09-02 02:32:52', '2024-09-02 02:33:06', NULL),
...
(5, 14, 'Maintenance Office', 60, '2024-09-02 02:20:07', '2024-09-02 02:20:07'),
(6, 16, 'Gym', 5, '2024-09-02 06:11:12', '2024-09-02 06:11:12'),
(7, 17, 'Property Custodian Offc', 100, '2024-09-02 06:39:43', '2024-09-02 06:39:43');
...
(4, 'XYZ Gardening Inc', '064-123454-55', '09123456789', 'xyzgardening@xyx.com', 'Silingan ra nimos', '2024-09-02 02:13:06', '2024-09-02 06:37:51'),
...
(20, 'Bond', 'Agent James', 'Agent', '007', '$2y$10$iXRyG04WdCRzlEnvacxYG.3f0ispnV7yjyjx6tF.bgyrLOBE9wzXW', '2024-08-30 23:09:04', '2024-09-02 13:56:39', NULL),
...
--
ALTER TABLE `inv_inventory_transactions`
  ADD CONSTRAINT `inv_inventory_transactions_item_id_foreign` FOREIGN KEY (`item_id`) REFERENCES `inv_items` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `inv_inventory_transactions_supplier_id_foreign` FOREIGN KEY (`supplier_id`) REFERENCES `inv_suppliers` (`id`) ON DELETE SET NULL;
